...
class Categoria(models.Model):
    ...
    # Campo para armazenar um nome ou abreviação secundária da categoria (máximo de 20 caracteres).
    nome = models.CharField(max_length=20)

    # Campo para armazenar uma descrição mais detalhada da categoria (sem limite de caracteres específico).
